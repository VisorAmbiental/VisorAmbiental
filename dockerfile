...
CMD ["sh", "-c", "php artisan migrate --path=/database/migrations/custom/2022_04_24_000000_enable_postgis_extension.php && php artisan migrate --force && service nginx start && php-fpm"]